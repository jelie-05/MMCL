...
input_file_path = os.path.join(root, 'src/dataset/kitti_loader/Dataloader/filenames_complete/eigen_train_files.txt')
output_file_path = os.path.join(root, 'src/dataset/kitti_loader/Dataloader/filenames_complete/name_list_train.txt')
