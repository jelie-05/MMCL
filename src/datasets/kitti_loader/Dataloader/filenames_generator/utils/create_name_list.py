...
input_file_path = os.path.join(root, 'src/datasets/kitti_loader/Dataloader/filenames_generator/eigen_train_files.txt')
output_file_path = os.path.join(root, 'src/dataset/kitti_loader/Dataloader/filenames_generator/name_list_train.txt')
