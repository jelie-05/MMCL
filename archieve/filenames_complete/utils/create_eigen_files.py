...
# output_file_path = os.path.join(root,'src/datasets/kitti_loader/Dataloader/filenames_complete/eigen_all_files.txt')

sync_list_path = os.path.join(root,'src/datasets/kitti_loader/Dataloader/filenames_complete/utils/list_sync_test_10_03.txt')
output_file_path = os.path.join(root,'src/datasets/kitti_loader/Dataloader/filenames_complete/eigen_test_files_1003.txt')
