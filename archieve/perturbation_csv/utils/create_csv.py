...
x_range = (0.1, 0.5) # 0.02-0.1
y_range = (0.1, 0.5)
z_range = (0.1, 0.5)
range_rad1 = (0.5, 5) # 0.5-5
range_rad2 = (0.5, 5)
range_rad3 = (0.5, 5)
...
input_file_path = os.path.join(root,'src/datasets/kitti_loader/Dataloader/perturbation_csv/eigen_all_files.txt')
output_csv_file_path = os.path.join(root,'src/datasets/kitti_loader/Dataloader/perturbation_csv/perturbation_neg_all.csv')
